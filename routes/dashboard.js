...
const default_config = 'frequency=10|image_quality=25|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|nmsThreshold=0.1|skipFrames=20|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50|useTracking=1'

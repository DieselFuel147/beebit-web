...
("wizzledonker", X'ed5692a7965aa31cc775d7ef417c5f72', "Laptop #1", '2019-01-18', '1565417874', 'uuid=ed5692a7965aa31cc775d7ef417c5f72|frequency=20|image_quality=25|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|nmsThreshold=0.1|skipFrames=5|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50|useTracking=1', 1, 0),
...
("wizzledonker", X'7ef7b3a810db35eed6c0eaf506436905', "Raspberry Pi #2", '2019-05-14', '1565418166', 'uuid=3573871ba65032c9a7ae104979d55de9|frequency=20|image_quality=25|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|nmsThreshold=0.1|skipFrames=5|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50|useTracking=1', 1, 0),
...
(X'7ef7b3a810db35eed6c0eaf506436905'),

...
("wizzledonker", X'ed5692a7965aa31cc775d7ef417c5f72', "Laptop #1", '2019-01-18', '1565417874', 'uuid=ed5692a7965aa31cc775d7ef417c5f72|frequency=20|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|skipFrames=5|raspi=0|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50', 1),
("wizzledonker", X'3573871ba65032c9a7ae104979d55de9', "Raspberry Pi #1", '2019-02-14', '1565418166', 'uuid=3573871ba65032c9a7ae104979d55de9|frequency=20|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|skipFrames=5|raspi=0|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50', 1),
("dj003", X'a7050cd5aa819b5a3396ad26a7230bda', "Extra Device", '2019-03-12', '1565414166', 'uuid=a7050cd5aa819b5a3396ad26a7230bda|frequency=20|model=dnn/yolov3.weights|config=dnn/config.cfg|confidence=0.2|skipFrames=5|raspi=0|imageWidth=320|imageHeight=240|useOpenCL=1|useCSRT=0|neuralNetQuality=416|maxDisappeared=50|searchDistance=50', 1);
